...
add wave -noupdate -group SubCPU -expand -group ic1_SRAM_SHARED /XSleenaCore_tb/xlc/xs_cpuAB/ic1/ADDR
add wave -noupdate -group SubCPU -expand -group ic1_SRAM_SHARED /XSleenaCore_tb/xlc/xs_cpuAB/ic1/WEn
add wave -noupdate -group SubCPU -expand -group ic1_SRAM_SHARED /XSleenaCore_tb/xlc/xs_cpuAB/ic1/DATA
...
update
WaveRestoreZoom {2880870992760 ps} {2880874587560 ps}
